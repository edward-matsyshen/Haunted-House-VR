...
public class LightFlickering : MonoBehaviour
{
    ...
    [Min(0), Tooltip("The audio pitch will randomize between the two values set here. For a constant pitch, set the two values to the same number.")]
    public Vector2 pitchRandomizer = new Vector2(0.9f, 1);
    ...
    {
        usedAudioSource = GetComponent<AudioSource>();
        usedAudioSource.spatialBlend = 1;
    }
